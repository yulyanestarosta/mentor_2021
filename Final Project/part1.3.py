...
file = fits.open('0851_202_u_2002_11_15_icn.fits')
file.info()

data = file[0].data
data = data.squeeze()
data1 = data[210:300, 240:330]
...
def diagram(length, size=0.1): ## size - размер пикселя, length - длина изображения по вертикали
    ...
    hdulist1 = fits.open('0851_202_u_2002_11_15_icn.fits')
    hdu1 = hdulist1[0]
    dlen = length
...
plt.title('0851+202, 2002.15.11')
plt.savefig('pic13.png', dpi=900)
plt.show()
plt.show()
